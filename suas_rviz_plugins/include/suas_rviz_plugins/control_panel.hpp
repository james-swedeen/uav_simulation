...
private:
  ...
  * \param state_listener_toggle_client Client to the state listener toggle service
  ...
  */
  ...
  rclcpp::Client<std_srvs::srv::Empty>::SharedPtr state_listener_toggle_client;
  rclcpp::Client<std_srvs::srv::Empty>::SharedPtr sense_auto_dyn_reset_client;
